...
const Page = () => {
    ...
    const fetchUser = async () => {
        try {
            ...
            try {
                const response = await fetch('/api/owner/profile/fetch-data', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                        ...
                        {passwordSection ? (
                            ...
                            <div className={`w-full`}>
                                ...
                                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 mt-5`}>
                                    ...
                                    {/*@ts-ignore*/}
                                    <InputWLabel label={'Phone Number'} inputType={'text'} placeHolder={'Phone Number'} handler={changeHandler} name={'contact'} value={userDetails['contact']}/>
                                    {/*@ts-ignore*/}
